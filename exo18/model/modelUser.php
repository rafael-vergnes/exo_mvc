...
class ModelUser extends Model{
    ...
    public function addUser() {
        try{
            ...
            $req = $this->getBDD()->prepare("INSERT INTO `user` (email, pseudo, `password`) VALUES (?, ?, ?)");
    ...
    public function update() {
        try{
            $req = $this->getBDD()->prepare("UPDATE `user` SET email = ?, pseudo = ?, `password` = ? WHERE id = ?");

            $req->bindParam(1, $this->email, PDO::PARAM_STR);
            $req->bindParam(2, $this->pseudo, PDO::PARAM_STR);
            $req->bindParam(3, $this->password, PDO::PARAM_STR);
            $req->bindParam(4, $this->id, PDO::PARAM_STR);
